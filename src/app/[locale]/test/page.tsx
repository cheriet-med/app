...
const ProfileCard: React.FC = () => {
 const options: ApexOptions = {
  ...
  return (
<div className="mx-2 my-32 grid  grid-cols-1 md:grid-cols-2 gap-6"> 
 ...
 <GoPencil size={18}/>
    ...
    Edit
     ...
     <h1 className='font-medium font-playfair'>About Me</h1>
      ...
      <h1 className="mt-4 mb-8 font-medium font-playfair">My interests</h1>
      <div className='flex gap-2 flex-wrap'>
...
{/* Reviews */ }
 ...
 <MdOutlineRateReview size={18}/>
    ...
    Write Review
     ...
     <h1 className='font-medium font-playfair mb-4'>Reviews</h1>
...
{/*Score */ }
 ...
 <div className='border border-1 rounded-2xl p-6 shadow-sm bg-white'>
     ...
     <h1 className='font-medium font-playfair mb-8'>Trust Score</h1>
