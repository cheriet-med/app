...
export default function Pricing() {
  return (
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl font-playfair text-a">
          Choose the right plan for you
        </p>
      </div>
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600 text-accent">
